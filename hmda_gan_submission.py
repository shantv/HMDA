...
class HMDA_GAN():
    ...
    def build_generator(self):
        ...
        gen_output = Dense(len(features), activation='tanh',name='gen_output')(X)
    ...
    def train(self,epochs,batch_size,save_interval):
        ...
        for epoch in range(epochs):
            ...
            d_loss_fake,_,_,d_acc_fake,_ = self.discriminator.train_on_batch(gen_x, [np.zeros((half_batch, 1)),np.zeros((half_batch,1))])
